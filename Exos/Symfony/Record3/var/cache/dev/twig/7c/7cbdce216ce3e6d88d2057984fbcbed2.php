...
class __TwigTemplate_448feb084dbee362c94fe12a844a505e extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        echo "
    <button class=\"btn btn-info text-light ml-3\">";
        // line 3
...
";
    ...
    {{ form_widget(form) }}
    <button class=\"btn btn-info text-light ml-3\">{{ button_label|default('Save') }}</button>
{{ form_end(form) }}
", "user/_form.html.twig", "/home/alexis/Documents/DIW22091/Exos/Symfony/Record3/templates/user/_form.html.twig");
    }
}
